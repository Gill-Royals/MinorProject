...
while True:
    ...
    if result.multi_hand_landmarks:
        for hand_landmarks in result.multi_hand_landmarks:
            ...
            # Add letter (no repeat)
            if final_pred != "..." and final_pred != last_pred:
    ...
    # Split
    right_width = int(canvas_width * 0.4)   # 40%
    left_width = canvas_width - right_width # 60%
    ...
    # Controls
    cv2.putText(canvas, "SPACE = Space | BACKSPACE = Delete | Q = Quit",
                (40, 740),
                cv2.FONT_HERSHEY_SIMPLEX,
                0.5,
                (150, 150, 150),
